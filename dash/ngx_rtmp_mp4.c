...
static ngx_int_t
ngx_rtmp_mp4_write_frma(ngx_buf_t *b)
{
    u_char  *pos;
...
static ngx_int_t
ngx_rtmp_mp4_write_svideo(ngx_rtmp_session_t *s, ngx_buf_t *b)
{
    u_char                *pos;
    ngx_rtmp_codec_ctx_t  *codec_ctx;
